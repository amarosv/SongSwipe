          ...
          : Stack(
              children: [
                SingleChildScrollView(
                  child: Column(
                    children: [
                      // Portada y botón de reproducción
                      Stack(
                        children: [
                          Image.network(_track.md5Image),
                          Positioned(
                            bottom: 10,
                            right: 20,
                                  ...
                                  value: capitalizeFirstLetter(
                                      text: _track.explicitLyrics ||
                                              _track.explicitContentCover ==
                                                  1 ||
                                              _track.explicitContentLyrics == 1
                                          ? localization.yes
                                          : localization.no),
                                ),
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Align(
                                              alignment: Alignment.topLeft,
                                              child: Text(
                                                capitalizeFirstLetter(text: localization.see_more),
                                                style: TextStyle(
                                                    fontWeight:
                                                        FontWeight.bold),
